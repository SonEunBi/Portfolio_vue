    ...
    move(menu){
      ...
      case "Home" :
        ...
        case "Skills":
           ...
           break;
        case "Project":
          pos=this.$refs.home.$el.clientHeight + this.$refs.about.$el.clientHeight+this.$refs.project.$el.clientHeight
          break;
     case "Contact":
        pos=this.$refs.home.$el.clientHeight + this.$refs.about.$el.clientHeight+this.$refs.project.$el.clientHeight+this.$refs.contact.$el.clientHeight
    break;
    }
